...
<body>
    ...
    <div class="w-full h-screen">
        ...
        <nav class="bg-white border-gray-200 px-2 sm:px-4 py-2.5 rounded shadow-md sticky w-full">
            ...
            <div class="flex items-center md:order-2">
                ...
                <button type="button" class="flex mr-3 text-sm bg-gray-800 rounded-full md:mr-0 focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600" id="user-menu-button" aria-expanded="false" data-dropdown-toggle="user-dropdown" data-dropdown-placement="bottom">
                    ...
                    <img src="https://flowbite.com/docs/images/logo.svg" class="w-8 h-8 rounded-full" alt="user">
                </button>
                <!-- Dropdown menu -->
        ...
        <div class="mx-auto">
            <div class="flex flex-row flex-wrap py-4">
                ...
                <aside class="w-full sm:w-1/3 md:w-1/5 px-1  h-screen" aria-label="Sidebar">
                    <div class="sticky top-0 p-3 w-full">
                        <ul class="space-y-2">
                            <li>
                ...
                <main role="main" class="w-full sm:w-2/3 md:w-3/4 pt-1 px-2 border-l">
    ...
    {{-- <footer class="mt-auto bg-slate-500">
        Footer
    </footer> --}}
